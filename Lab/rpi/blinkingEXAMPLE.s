...
red1:					/* write a 1 in a pin pin */
	...
	bl digitalRead		/* call digitalRead */
	cmp r0, #0			/* check pin state is 0 */
	bne red2			/* if not 0, no button pushed, continue blinking */

red2:
						/* write a 1 in a pin pin */
						/* digitalWrite(int pin, int value) */
	mov r0, #RLED2		/* give pin */
	mov r1, #1			/* put value 1 */
	bl digitalWrite		/* call digitalWrite */
						/* wait half a second */
						/* delay(int ms) */
	...
	bl digitalRead		/* call digitalRead */
	cmp r0, #0			/* check pin state is 0 */
	bne yellow1			/* if not 0, no button pushed, continue blinking */

yellow1:
						/* write a 1 in a pin pin */
						/* digitalWrite(int pin, int value) */
	mov r0, #YLED1		/* give pin */
	mov r1, #1			/* put value 1 */
	bl digitalWrite		/* call digitalWrite */
						/* wait half a second */
						/* delay(int ms) */
	...
	bl digitalRead		/* call digitalRead */
	cmp r0, #0			/* check pin state is 0 */
	bne yellow2			/* if not 0, no button pushed, continue blinking */
						
yellow2:
						/* write a 1 in a pin pin */
						/* digitalWrite(int pin, int value) */
	mov r0, #YLED2		/* give pin */
	mov r1, #1			/* put value 1 */
	bl digitalWrite		/* call digitalWrite */
						/* wait half a second */
						/* delay(int ms) */
	...
	bl digitalRead		/* call digitalRead */
	cmp r0, #0			/* check pin state is 0 */
	bne green1			/* if not 0, no button pushed, continue blinking */
						
green1:
						/* write a 1 in a pin pin */
						/* digitalWrite(int pin, int value) */
	mov r0, #GLED1		/* give pin */
	mov r1, #1			/* put value 1 */
	bl digitalWrite		/* call digitalWrite */
						/* wait half a second */
						/* delay(int ms) */
	...
	bl digitalRead		/* call digitalRead */
	cmp r0, #0			/* check pin state is 0 */
	bne green2			/* if not 0, no button pushed, continue blinking */
						
green2:
						/* write a 1 in a pin pin */
						/* digitalWrite(int pin, int value) */
	mov r0, #GLED2		/* give pin */
	mov r1, #1			/* put value 1 */
	bl digitalWrite		/* call digitalWrite */
						/* wait half a second */
						/* delay(int ms) */
	...
	bl digitalRead		/* call digitalRead */
	cmp r0, #0			/* check pin state is 0 */
	bne red1			/* if not 0, no button pushed, continue blinking */
